	...
	<body>
	    ...
	    <div class="address">
	        <table class="recipient">
	            ...
	            <tr>
					<td class="name">${order.partner_id.parent_id.name or ''}</td>
				</tr>
	            <tr>
					<td>${order.partner_id.title and order.partner_id.title.name or ''} ${order.partner_id.name }</td>
				</tr>
	            <% address_lines = order.partner_id.contact_address.split("\n")[1:] %>
	            %else:
	            <tr>
					<td class="name">${order.partner_id.title and order.partner_id.title.name or ''} ${order.partner_id.name }</td>
				</tr>
	            <% address_lines = order.partner_id.contact_address.split("\n") %>
	            %endif
